...
<section class="grid grid-cols-1 md:grid-cols-2 h-full pb-18 pl-14" id="home">
    ...
    <div class="relative w-screen h-full content-center flex justify-center pt-24 md:w-full md:pl-20">
        <div class=" text-center md:text-left">
            ...
            <div class="text-orange-500 font-bold text-3xl md:text-6xl">
                KESUKSESAN WEBSITEMU
            </div>
            <div class="text-black text-base font-medium font-bold text-3xl md:text-base">
                Qwords menawarkan layanan Cloud Hosting yang Cepat,<br>
                Aman, dan Dukungan 24 jam untuk memenuhi kebutuhan hosting anda.<br>
...
<div class="relative -mt-12 lg:-mt-26">
